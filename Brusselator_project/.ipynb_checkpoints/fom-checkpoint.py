...
def create_fom(nt=64, h=50, time=9):
    ...
    # 'inverse': {
    #     'type': 'newton',
    #     'rtol': 1e-6,          # Leicht gelockert (reicht für den Euler völlig)
    #     'atol': 1e-8,
    #     'maxiter': 100,         # Mehr als 10 Iterationen braucht der Newton hier nie
    #     'line_search': False   
    #     }
    # }
